import { auth, db, signInWithEmailAndPassword, createUserWithEmailAndPassword, onAuthStateChanged, GoogleAuthProvider, signInWithPopup, ref, set, get, update, onValue } from "./firebase-config.js";
...
if (btnGoogleLogin) {
    btnGoogleLogin.addEventListener('click', async () => {
        authError.textContent = "Вход через Google...";
        ...
        try {
            ...
            console.error(error);
            authError.textContent = "Ошибка Google: " + error.message;
        }
    });
}
