import { auth, db, onAuthStateChanged, doc, setDoc, getDoc, updateDoc, onSnapshot } from "./firebase-config.js";
...
onAuthStateChanged(auth, (user) => {
    if (user) {
        ...
        // If not logged in, they can't use services. Redirect them to index.html or show alert.
        alert("Вам необходимо войти в систему на главной странице!");
