import { auth, db, onAuthStateChanged, ref, set, get, update, onValue, GoogleAuthProvider, signInWithPopup, signOut } from "./firebase-config.js";
...
if (btnGoogleLogin) {
    btnGoogleLogin.addEventListener('click', async () => {
        document.getElementById('auth-status').textContent = "Вход через Google...";
        ...
        try {
            ...
            document.getElementById('auth-status').textContent = "Требуется авторизация владельца";
        }
    });
}
